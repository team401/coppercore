...
public class Controllers {
    ...
    public static void registerControllerType(
            String name, Function<Integer, GenericHID> hidFunction) {
        ...
        return (Controller.Button)
                getFromAllControllers(
                        (controller, cmd) -> {
                            ...
                            Controller.ControllerInterface ci =
                                    controller.getControllerInterface(cmd);
