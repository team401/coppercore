...
public class LinearDriveMath {
  ...
  public LinearDriveMath(DriveTemplate drive) {
    this.drive = drive;
  }
  ...
  private Pose2d findPhase1Pose(Pose2d phase2Pose) {
    ...
    double phase1OffsetX = kDriveToPointPhase2Distance
            * Math.cos(phase2Pose.getRotation().getRadians() + Math.PI);
    double phase1OffsetY = kDriveToPointPhase2Distance
